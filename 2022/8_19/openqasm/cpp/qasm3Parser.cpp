...
std::once_flag qasm3parserParserOnceFlag;
...
void qasm3parserParserInitialize() {
  ...
  auto staticData = std::make_unique<Qasm3ParserStaticData>(
    ...
    std::vector<std::string>{
      ...
      "INPUT", "OUTPUT", "CONST", "MUTABLE", "QREG", "QUBIT", "CREG", "BOOL", 
      "BIT", "INT", "UINT", "FLOAT", "ANGLE", "COMPLEX", "ARRAY", "DURATION", 
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,107,798,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	23,2,0,26,26,28,28,2,0,61,61,79,79,2,0,65,65,76,77,2,0,50,50,83,92,2,
  	0,66,66,68,69,2,0,63,63,65,65,1,0,42,43,1,0,24,25,2,0,46,48,88,88,1,0,
  	88,89,881,0,129,1,0,0,0,2,139,1,0,0,0,4,180,1,0,0,0,6,182,1,0,0,0,8,186,
  	...
  	5,1,0,0,140,141,5,99,0,0,141,142,5,58,0,0,142,3,1,0,0,0,143,181,3,10,
  	...
  	5,21,0,0,183,185,5,102,0,0,184,183,1,0,0,0,184,185,1,0,0,0,185,7,1,0,
  	0,0,186,190,5,53,0,0,187,189,3,4,2,0,188,187,1,0,0,0,189,192,1,0,0,0,
  	190,188,1,0,0,0,190,191,1,0,0,0,191,193,1,0,0,0,192,190,1,0,0,0,193,194,
  	5,54,0,0,194,9,1,0,0,0,195,196,5,20,0,0,196,197,5,102,0,0,197,11,1,0,
  	0,0,198,201,3,4,2,0,199,201,3,8,4,0,200,198,1,0,0,0,200,199,1,0,0,0,201,
  	13,1,0,0,0,202,203,5,3,0,0,203,204,5,93,0,0,204,205,5,58,0,0,205,15,1,
  	0,0,0,206,207,5,2,0,0,207,208,5,93,0,0,208,209,5,58,0,0,209,17,1,0,0,
  	0,210,211,5,11,0,0,211,212,5,58,0,0,212,19,1,0,0,0,213,214,5,12,0,0,214,
  	215,5,58,0,0,215,21,1,0,0,0,216,217,5,15,0,0,217,218,5,58,0,0,218,23,
  	1,0,0,0,219,220,5,17,0,0,220,221,3,92,46,0,221,222,5,88,0,0,222,229,5,
  	19,0,0,223,230,3,80,40,0,224,225,5,51,0,0,225,226,3,78,39,0,226,227,5,
  	52,0,0,227,230,1,0,0,0,228,230,5,88,0,0,229,223,1,0,0,0,229,224,1,0,0,
  	0,229,228,1,0,0,0,230,231,1,0,0,0,231,232,3,12,6,0,232,25,1,0,0,0,233,
  	234,5,13,0,0,234,235,5,55,0,0,235,236,3,70,35,0,236,237,5,56,0,0,237,
  	240,3,12,6,0,238,239,5,14,0,0,239,241,3,12,6,0,240,238,1,0,0,0,240,241,
  	1,0,0,0,241,27,1,0,0,0,242,245,5,16,0,0,243,246,3,70,35,0,244,246,3,76,
  	38,0,245,243,1,0,0,0,245,244,1,0,0,0,245,246,1,0,0,0,246,247,1,0,0,0,
  	247,248,5,58,0,0,248,29,1,0,0,0,249,250,5,18,0,0,250,251,5,55,0,0,251,
  	252,3,70,35,0,252,253,5,56,0,0,253,254,3,12,6,0,254,31,1,0,0,0,255,257,
  	5,49,0,0,256,258,3,124,62,0,257,256,1,0,0,0,257,258,1,0,0,0,258,259,1,
  	754,1,0,0,0,757,760,1,0,0,0,758,756,1,0,0,0,758,759,1,0,0,0,759,762,1,
  	0,0,0,760,758,1,0,0,0,761,763,5,60,0,0,762,761,1,0,0,0,762,763,1,0,0,
  	0,763,121,1,0,0,0,764,769,5,88,0,0,765,766,5,60,0,0,766,768,5,88,0,0,
  	767,765,1,0,0,0,768,771,1,0,0,0,769,767,1,0,0,0,769,770,1,0,0,0,770,773,
  	1,0,0,0,771,769,1,0,0,0,772,774,5,60,0,0,773,772,1,0,0,0,773,774,1,0,
  	0,0,774,123,1,0,0,0,775,780,3,108,54,0,776,777,5,60,0,0,777,779,3,108,
  	54,0,778,776,1,0,0,0,779,782,1,0,0,0,780,778,1,0,0,0,780,781,1,0,0,0,
  	781,784,1,0,0,0,782,780,1,0,0,0,783,785,5,60,0,0,784,783,1,0,0,0,784,
  	785,1,0,0,0,785,125,1,0,0,0,786,791,3,110,55,0,787,788,5,60,0,0,788,790,
  	3,110,55,0,789,787,1,0,0,0,790,793,1,0,0,0,791,789,1,0,0,0,791,792,1,
  	0,0,0,792,795,1,0,0,0,793,791,1,0,0,0,794,796,5,60,0,0,795,794,1,0,0,
...
qasm3Parser::ProgramContext* qasm3Parser::program() {
  ...
  try {
    ...
    while ((((_la & ~ 0x3fULL) == 0) &&
      ...
      | (1ULL << qasm3Parser::LPAREN))) != 0) || ((((_la - 65) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 65)) & ((1ULL << (qasm3Parser::MINUS - 65))
      | (1ULL << (qasm3Parser::TILDE - 65))
      | (1ULL << (qasm3Parser::EXCLAMATION_POINT - 65))
      | (1ULL << (qasm3Parser::ImaginaryLiteral - 65))
      | (1ULL << (qasm3Parser::BinaryIntegerLiteral - 65))
      | (1ULL << (qasm3Parser::OctalIntegerLiteral - 65))
      | (1ULL << (qasm3Parser::DecimalIntegerLiteral - 65))
      | (1ULL << (qasm3Parser::HexIntegerLiteral - 65))
      | (1ULL << (qasm3Parser::Identifier - 65))
      | (1ULL << (qasm3Parser::HardwareQubit - 65))
      | (1ULL << (qasm3Parser::FloatLiteral - 65))
      | (1ULL << (qasm3Parser::TimingLiteral - 65))
      | (1ULL << (qasm3Parser::BitstringLiteral - 65)))) != 0)) {
      setState(131);
      statement();
      setState(136);
      _errHandler->sync(this);
  ...
  try {
    ...
    case 1: {
      ...
      if (_la == qasm3Parser::LPAREN) {
        ...
        _la = _input->LA(1);
        if (((((_la - 29) & ~ 0x3fULL) == 0) &&
          ((1ULL << (_la - 29)) & ((1ULL << (qasm3Parser::BOOL - 29))
          | (1ULL << (qasm3Parser::BIT - 29))
          | (1ULL << (qasm3Parser::INT - 29))
          | (1ULL << (qasm3Parser::UINT - 29))
          | (1ULL << (qasm3Parser::FLOAT - 29))
          | (1ULL << (qasm3Parser::ANGLE - 29))
          | (1ULL << (qasm3Parser::COMPLEX - 29))
          | (1ULL << (qasm3Parser::ARRAY - 29))
          | (1ULL << (qasm3Parser::DURATION - 29))
          | (1ULL << (qasm3Parser::STRETCH - 29))
          | (1ULL << (qasm3Parser::DURATIONOF - 29))
          | (1ULL << (qasm3Parser::BooleanLiteral - 29))
          | (1ULL << (qasm3Parser::LPAREN - 29))
          | (1ULL << (qasm3Parser::MINUS - 29))
          | (1ULL << (qasm3Parser::TILDE - 29))
          | (1ULL << (qasm3Parser::EXCLAMATION_POINT - 29))
          | (1ULL << (qasm3Parser::ImaginaryLiteral - 29))
          | (1ULL << (qasm3Parser::BinaryIntegerLiteral - 29))
          | (1ULL << (qasm3Parser::OctalIntegerLiteral - 29))
          | (1ULL << (qasm3Parser::DecimalIntegerLiteral - 29))
          | (1ULL << (qasm3Parser::HexIntegerLiteral - 29))
          | (1ULL << (qasm3Parser::Identifier - 29))
          | (1ULL << (qasm3Parser::HardwareQubit - 29))
          | (1ULL << (qasm3Parser::FloatLiteral - 29))
          | (1ULL << (qasm3Parser::TimingLiteral - 29))
          | (1ULL << (qasm3Parser::BitstringLiteral - 29)))) != 0)) {
          setState(282);
          expressionList();
        }
        setState(285);
  ...
  try {
    ...
    case 2: {
      ...
      if (!(((((_la - 65) & ~ 0x3fULL) == 0) &&
        ((1ULL << (_la - 65)) & ((1ULL << (qasm3Parser::MINUS - 65))
        | (1ULL << (qasm3Parser::TILDE - 65))
        | (1ULL << (qasm3Parser::EXCLAMATION_POINT - 65)))) != 0))) {
    ...
    case 6: {
      ...
      _la = _input->LA(1);
      if (!(((((_la - 50) & ~ 0x3fULL) == 0) &&
        ((1ULL << (_la - 50)) & ((1ULL << (qasm3Parser::BooleanLiteral - 50))
        | (1ULL << (qasm3Parser::ImaginaryLiteral - 50))
        | (1ULL << (qasm3Parser::BinaryIntegerLiteral - 50))
        | (1ULL << (qasm3Parser::OctalIntegerLiteral - 50))
        | (1ULL << (qasm3Parser::DecimalIntegerLiteral - 50))
        | (1ULL << (qasm3Parser::HexIntegerLiteral - 50))
        | (1ULL << (qasm3Parser::Identifier - 50))
        | (1ULL << (qasm3Parser::HardwareQubit - 50))
        | (1ULL << (qasm3Parser::FloatLiteral - 50))
        | (1ULL << (qasm3Parser::TimingLiteral - 50))
        | (1ULL << (qasm3Parser::BitstringLiteral - 50)))) != 0))) {
      _errHandler->recoverInline(this);
      }
      else {
        _errHandler->reportMatch(this);
    ...
    while (alt != 2 && alt != atn::ATN::INVALID_ALT_NUMBER) {
      if (alt == 1) {
        ...
        case 2: {
          ...
          _la = _input->LA(1);
          if (!(((((_la - 66) & ~ 0x3fULL) == 0) &&
            ((1ULL << (_la - 66)) & ((1ULL << (qasm3Parser::ASTERISK - 66))
            | (1ULL << (qasm3Parser::SLASH - 66))
            | (1ULL << (qasm3Parser::PERCENT - 66)))) != 0))) {
...
tree::TerminalNode* qasm3Parser::ArrayReferenceTypeContext::CONST() {
  return getToken(qasm3Parser::CONST, 0);
}
...
qasm3Parser::DefcalTargetContext* qasm3Parser::defcalTarget() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!(((((_la - 46) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 46)) & ((1ULL << (qasm3Parser::DELAY - 46))
      | (1ULL << (qasm3Parser::RESET - 46))
      | (1ULL << (qasm3Parser::MEASURE - 46))
      | (1ULL << (qasm3Parser::Identifier - 46)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
void qasm3Parser::initialize() {
  std::call_once(qasm3parserParserOnceFlag, qasm3parserParserInitialize);
}
