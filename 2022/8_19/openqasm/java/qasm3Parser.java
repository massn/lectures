...
public class qasm3Parser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INCLUDE) | (1L << DEFCALGRAMMAR) | (1L << DEF) | (1L << CAL) | (1L << DEFCAL) | (1L << GATE) | (1L << EXTERN) | (1L << BOX) | (1L << LET) | (1L << BREAK) | (1L << CONTINUE) | (1L << IF) | (1L << END) | (1L << RETURN) | (1L << FOR) | (1L << WHILE) | (1L << PRAGMA) | (1L << AnnotationKeyword) | (1L << INPUT) | (1L << OUTPUT) | (1L << CONST) | (1L << QREG) | (1L << QUBIT) | (1L << CREG) | (1L << BOOL) | (1L << BIT) | (1L << INT) | (1L << UINT) | (1L << FLOAT) | (1L << ANGLE) | (1L << COMPLEX) | (1L << ARRAY) | (1L << DURATION) | (1L << STRETCH) | (1L << GPHASE) | (1L << INV) | (1L << POW) | (1L << CTRL) | (1L << NEGCTRL) | (1L << DURATIONOF) | (1L << DELAY) | (1L << RESET) | (1L << MEASURE) | (1L << BARRIER) | (1L << BooleanLiteral) | (1L << LPAREN))) != 0) || ((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (MINUS - 65)) | (1L << (TILDE - 65)) | (1L << (EXCLAMATION_POINT - 65)) | (1L << (ImaginaryLiteral - 65)) | (1L << (BinaryIntegerLiteral - 65)) | (1L << (OctalIntegerLiteral - 65)) | (1L << (DecimalIntegerLiteral - 65)) | (1L << (HexIntegerLiteral - 65)) | (1L << (Identifier - 65)) | (1L << (HardwareQubit - 65)) | (1L << (FloatLiteral - 65)) | (1L << (TimingLiteral - 65)) | (1L << (BitstringLiteral - 65)))) != 0)) {
				{
				{
				setState(131);
				statement();
		...
		try {
			...
			case 1:
				...
				if (_la==LPAREN) {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if (((((_la - 29)) & ~0x3f) == 0 && ((1L << (_la - 29)) & ((1L << (BOOL - 29)) | (1L << (BIT - 29)) | (1L << (INT - 29)) | (1L << (UINT - 29)) | (1L << (FLOAT - 29)) | (1L << (ANGLE - 29)) | (1L << (COMPLEX - 29)) | (1L << (ARRAY - 29)) | (1L << (DURATION - 29)) | (1L << (STRETCH - 29)) | (1L << (DURATIONOF - 29)) | (1L << (BooleanLiteral - 29)) | (1L << (LPAREN - 29)) | (1L << (MINUS - 29)) | (1L << (TILDE - 29)) | (1L << (EXCLAMATION_POINT - 29)) | (1L << (ImaginaryLiteral - 29)) | (1L << (BinaryIntegerLiteral - 29)) | (1L << (OctalIntegerLiteral - 29)) | (1L << (DecimalIntegerLiteral - 29)) | (1L << (HexIntegerLiteral - 29)) | (1L << (Identifier - 29)) | (1L << (HardwareQubit - 29)) | (1L << (FloatLiteral - 29)) | (1L << (TimingLiteral - 29)) | (1L << (BitstringLiteral - 29)))) != 0)) {
						{
						setState(282);
						expressionList();
						}
	...
	public final DefStatementContext defStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CONST) | (1L << MUTABLE) | (1L << QREG) | (1L << QUBIT) | (1L << CREG) | (1L << BOOL) | (1L << BIT) | (1L << INT) | (1L << UINT) | (1L << FLOAT) | (1L << ANGLE) | (1L << COMPLEX) | (1L << DURATION) | (1L << STRETCH))) != 0)) {
				{
				setState(374);
	...
	public final ExternStatementContext externStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << CONST) | (1L << MUTABLE) | (1L << CREG) | (1L << BOOL) | (1L << BIT) | (1L << INT) | (1L << UINT) | (1L << FLOAT) | (1L << ANGLE) | (1L << COMPLEX) | (1L << DURATION) | (1L << STRETCH))) != 0)) {
				{
				setState(386);
				externArgumentList();
				}
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 65)) & ~0x3f) == 0 && ((1L << (_la - 65)) & ((1L << (MINUS - 65)) | (1L << (TILDE - 65)) | (1L << (EXCLAMATION_POINT - 65)))) != 0)) ) {
			...
			case 6:
				...
				setState(470);
				_la = _input.LA(1);
				if ( !(((((_la - 50)) & ~0x3f) == 0 && ((1L << (_la - 50)) & ((1L << (BooleanLiteral - 50)) | (1L << (ImaginaryLiteral - 50)) | (1L << (BinaryIntegerLiteral - 50)) | (1L << (OctalIntegerLiteral - 50)) | (1L << (DecimalIntegerLiteral - 50)) | (1L << (HexIntegerLiteral - 50)) | (1L << (Identifier - 50)) | (1L << (HardwareQubit - 50)) | (1L << (FloatLiteral - 50)) | (1L << (TimingLiteral - 50)) | (1L << (BitstringLiteral - 50)))) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						...
						_la = _input.LA(1);
						if ( !(((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & ((1L << (ASTERISK - 66)) | (1L << (SLASH - 66)) | (1L << (PERCENT - 66)))) != 0)) ) {
	...
	public final DefcalTargetContext defcalTarget() throws RecognitionException {
		...
		try {
			...
			setState(684);
			_la = _input.LA(1);
			if ( !(((((_la - 46)) & ~0x3f) == 0 && ((1L << (_la - 46)) & ((1L << (DELAY - 46)) | (1L << (RESET - 46)) | (1L << (MEASURE - 46)) | (1L << (Identifier - 46)))) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
